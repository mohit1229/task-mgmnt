    ...
    <>
      <div className='bg-stone-950 text-white w-full h-full'>
        ...
        <div>
          ...
          <div className='w-full flex flex-col justify-center py-10 px-80 overflow-y-auto'>
            <div className='bg-stone-800 w-full rounded-lg p-4 max-h-96 overflow-y-auto'>
            <textarea
...
></textarea>
            ...
            <div className='bg-red-500 w-full mt-4 p-4 text-center'>Task List</div>
          </div>
        </div>
      </div>
    </>
